...
const accordions = [
  {
    ...
    const Accordion = ({
      ...
      return (
        <>
          <motion.div
            className={\`rounded-t-lg rounded-b-md  pb-2\`}
            variants={card}
            initial="collapsed"
      ...
      C307.322,253.536,311.161,255,315,255c3.839,0,7.678-1.464,10.607-4.394C331.464,244.748,331.464,235.251,325.606,229.393z"
            ...
            <motion.div
              ...
              className={\` rounded-b-lg px-2 text-xs text-gray-600\`}
            >
              {children}
            </motion.div>
          </motion.div>
    ...
    <section className="w-full">
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        {accordions.map((accordion) => (
          <Tabs key={accordion.key} defaultValue="component" className="w-full">
            <TabsList>
              <TabsTrigger value="component">Component</TabsTrigger>
              <TabsTrigger value="code">Code</TabsTrigger>
            </TabsList>
            <TabsContent value="component">{accordion.component}</TabsContent>
            <TabsContent value="code">
              {" "}
              <SyntaxHighlighterWrapper
                codeString={accordion.codeString}
                title=".tsx"
                column
              ></SyntaxHighlighterWrapper>
              .
